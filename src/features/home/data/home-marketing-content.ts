...
export const HOME_ITHRACODE_FAQ = {
  ...
  answer:
    'IthraCode منصة تعليمية عربية لتعلّم البرمجة من خلال تجارب وخبرات واقعية من الشركات. نقدّم دورات ومسارات عملية في تطوير الويب، بقيادة المدرّبة هدى أبو هشيمة، لمساعدتك على بناء مهارات قابلة للتطبيق والوصول إلى فرص أفضل في سوق العمل — تحت شعار «تعلّم البرمجة من الواقع».',
} as const;
