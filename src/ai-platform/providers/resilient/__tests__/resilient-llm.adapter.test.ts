...
import { ResilientLlmAdapter } from '@/ai-platform/providers/resilient/resilient-llm.adapter';
import { LlmError, LlmErrorCodes, type LlmPort } from '@/ai-platform/domain/ports/llm.port';
...
describe('ResilientLlmAdapter (platform)', () => {
