...
function getDefaultChunkOptions(): Required<ChunkOptions> {
  return {
    maxChars: AI_PLATFORM_CONSTANTS.INDEXING_CHUNK_MAX_CHARS,
    overlapChars: AI_PLATFORM_CONSTANTS.INDEXING_CHUNK_OVERLAP_CHARS,
    minChars: AI_PLATFORM_CONSTANTS.INDEXING_CHUNK_MIN_CHARS,
    maxTokens: AI_PLATFORM_CONSTANTS.INDEXING_MAX_TOKENS_PER_CHUNK,
  };
}
