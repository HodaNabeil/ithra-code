...
export type GetWebhookEventGroupByPayload<T extends WebhookEventGroupByArgs> =
...
export type WebhookEventWhereInput = {
  ...
  provider?:
    | Prisma.EnumPaymentProviderFilter<'WebhookEvent'>
...
export type WebhookEventScalarWhereWithAggregatesInput = {
  ...
  provider?:
    | Prisma.EnumPaymentProviderWithAggregatesFilter<'WebhookEvent'>
    | $Enums.PaymentProvider;
...
> = runtime.Types.Extensions.GetOmit<
  'id' | 'provider' | 'type' | 'providerEventId' | 'payload' | 'receivedAt',
  ExtArgs['result']['webhookEvent']
>;
